...
| Publication | Alpha.14 publication authorized using completed native, tool, signing and upgrade checks | Limited internal alpha scope; hourly frontend lifecycle not claimed |
